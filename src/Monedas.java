...
public class Monedas {
    ...
    public Monedas (ConsultaApi conversion) {this.conversion = conversion;}
    ...
    public void almacenarValores(String monedaBase, String monedaDestino){
    ...
    public void almacenarValoresPersonalizados(){
        ...
        System.out.println("Ingrese la moneda de destino con 3 letras");
        ...
        do {
            ...
            if (lectura.hasNextDouble()){
                ...
                System.out.println("Error ingrese el valor numerico");
                lectura.next();
            }
        }while (!entradaValida);
    }
    public String obtenerMensajeRespuesta() {
        String mensaje = getMonedaBase().toUpperCase() + " " + getCantidad() + " equivale a: " + getMonedaDestino().toUpperCase() + " " + conversion.buscaConversion(getMonedaBase(), getMonedaDestino(), getCantidad());
